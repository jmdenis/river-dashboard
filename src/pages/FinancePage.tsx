...
const statValue: React.CSSProperties = { ...tokens.typography.display, letterSpacing: '-0.02em' }
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-[13px] text-[var(--text-2)]">Comprehensive financial overview</p>
      </div>

      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        <Card>
          <CardHeader className="pb-2"><p className="text-[13px] text-[var(--text-2)]">Total Income</p></CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2"><p className="text-[13px] text-[var(--text-2)]">Total Expenses</p></CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2"><p className="text-[13px] text-[var(--text-2)]">Savings Rate</p></CardHeader>
          <CardContent><p style={{ ...statValue, color: tokens.colors.textPrimary }}>{savingsRate.toFixed(1)}%</p></CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2"><p className="text-[13px] text-[var(--text-2)]">Subscriptions</p></CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2"><p className="text-[13px] text-[var(--text-2)]">Potential Savings</p></CardHeader>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader className="pb-2"><p className="text-[13px] text-[var(--text-2)]">Total Annual Waste</p></CardHeader>
          <CardContent><p className="text-red-400" style={statValue}>{'\u20AC'}{waste.totals.total_annual_waste.toLocaleString('fr-FR')}</p></CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2"><p className="text-[13px] text-[var(--text-2)]">Bank Fees</p></CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2"><p className="text-[13px] text-[var(--text-2)]">Small Forgotten Charges</p></CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-[13px] text-[var(--text-2)]">Prioritized recommendations with estimated savings</p>
        </CardHeader>
        <CardContent>
